...
public class BJ_1620 {
    public static void main(String[] args) throws IOException {
        BJ_1620 test = new BJ_1620();
    }

    public BJ_1620() throws IOException {
        BufferedReader br = new BufferedReader(new InputStreamReader(System.in));
        StringTokenizer stk = new StringTokenizer(br.readLine()," ");
        StringBuilder sb = new StringBuilder();
        int cnt = Integer.parseInt(stk.nextToken());
        int quary_cnt = Integer.parseInt(stk.nextToken());

        Map<Integer,String> idx_map = new HashMap<>();
        ...
        for (int i = 0 ; i <quary_cnt;i++){
            sb.append(solution(idx_map,string_map,br.readLine())).append("\n");
        }

        System.out.println(sb);
    }

    private String solution(Map<Integer, String> idx_map, Map<String, Integer> string_map, String data) {


        if(data.matches("[0-9]*+")){
            //숫자
            return idx_map.get(Integer.parseInt(data));
        }else{
            return Integer.toString(string_map.get(data));
        }
