...
1 초	128 MB	74376	34651	23648	45.280%
문제
...
public class BJ_2606 {
    public static void main(String[] args) throws IOException {
        BJ_2606 test = new BJ_2606();
    }

    public BJ_2606() throws IOException {
    ...
    private int bfs (boolean[][] arr, boolean[] visit, int start) {
        //들어올때마다 1
        int result =0;
